                                ...
                                <table class="table table-striped" id="table1">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    <td>
                                                        <input type="checkbox" name="checkbox[]" class="form-check-input" id="checkbox<?php echo $row["purchasing_id"] ?>" value="<?php echo $row["purchasing_id"] ?>" <?php if ($status == true) {
                                                                                                                                                                                                                            echo "disabled";
                                                                                                                                                                                                                        } ?>>
                                                        <label for="checkbox<?php echo $row["purchasing_id"] ?>"></label>
                                                    </td>
                                                    <td>
                                                        <?php echo $row["purchasing_id"] ?>
                                                    </td>
