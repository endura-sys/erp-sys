                                    ...
                                    <?php
                                        ...
                                        if ($result->num_rows > 0) {
                                            ...
                                            while($row = $result->fetch_assoc()) {
                                                ...
                                                echo "<tr><td>" .$row["customer_id"] ."</td><td>" .$row["name"] ."</td><td>" .$row["gender"] ."</td><td>" .$row["contact_no."] ."</td><td>" .$row["contact_email"] . "</td><td>" .$row["address"] ."</td><td>" .$row["member_point"] ."</td><td>" .$row["date_of_last_purchasing"]. "</td>";
                                            }
                                        } else {
                                            echo "0 results";
                                        }
